...
class DiscoveryError(WittyMCPError):
    ...
    def __init__(self, message: str, server_id: str | None = None) -> None:
...
class AdapterError(WittyMCPError):
    ...
    def __init__(self, message: str, adapter_type: str | None = None) -> None:
...
class SessionError(WittyMCPError):
    ...
    def __init__(self, message: str, user_id: str | None = None, mcp_id: str | None = None) -> None:
...
class CommandNotAllowedError(SecurityError):
    ...
    def __init__(self, command: str, allowlist: list[str] | None = None) -> None:
        super().__init__(
...
class ToolCallError(WittyMCPError):
    ...
    def __init__(self, message: str, tool_name: str | None = None, mcp_id: str | None = None) -> None:
        super().__init__(message, "TOOL_CALL_ERROR")
        self.tool_name = tool_name
        self.mcp_id = mcp_id


class MCPTimeoutError(WittyMCPError):
    """超时错误"""
