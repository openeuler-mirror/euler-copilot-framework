...
本章节介绍如何使用  Witty Assistant 的 web 端进行智能问答，以下简称 witty web 。
...
witty web 智能问答支持多轮连续对话。只需要在同一个对话中继续追问即可使用，如图 4所示，witty web会根据上下文对用户的问题进行补全。
...
witty web 后台存在用户信息导出功能，如用户需要，需主动通过 <contact@openeuler.io> 邮箱联系我们，运维会将导出的用户信息通过邮箱回送给用户。
