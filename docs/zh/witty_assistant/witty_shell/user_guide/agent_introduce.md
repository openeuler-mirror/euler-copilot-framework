...
现阶段 Witty Assistant 平台已集成LLM chat、基础运维Agent两款智能体，其中 LLM chat聚焦智能对话问询能力，为用户提供自然语言交互支撑；基础运维Agent是面向openEuler基础运维领域的专用工具，其核心优势在于整合两大 MCP 服务能力，实现 openEuler 系统基础运维全场景覆盖与轻量化知识检索的有机结合；已知问题分析Agent将面向已知问题诊断场景开发。手册通过标准化的能力说明与实操案例，为企业运维人员提供 “即查即用” 的操作指引，助力降低运维门槛、提升运维工作的标准化与高效化水平。
