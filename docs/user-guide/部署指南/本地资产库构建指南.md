...
中间层的配置（链接源目录和目标目录的配置）在 https://gitee.com/openeuler/euler-copilot-framework/euler-copilot-helm/chart/templates/rag/rag-deployment.yaml 中，下面是文件中具体映射中间层的的配置方法：
...
![](./pictures/本地资产库构建/k8s集群中postgres服务的名称.png)
