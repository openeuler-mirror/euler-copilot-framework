...
[openEuler Intelligence 官方 Git 仓库](https://atomgit.com/openeuler/euler-copilot-framework)  
...
```bash
cd /home
git clone https://atomgit.com/openeuler/euler-copilot-framework -b release-0.10.1
```
#### 资源清单
...
# 镜像保存至 /home/eulercopilot/images/
./save_images.sh --version 0.10.1 --arch x86
# 传输至目标服务器：
